            ...
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>Merchandise Co.</span>
                        </a>
                    </div>
                    <ul>
                        <li>+91 9137992456</li>
                        <li>Merchandise Co.@gmail.com</li>
                        <li>MH-400068, Mumabai</li>
                    </ul>
                    <div class="footer-social">
                        <a href="https://www.facebook.com/aakash.kushwaha.7792052/" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://www.instagram.com/nikola__tesla_____/?hl=en" target="_blank"><i class="fa fa-instagram"></i></a>
